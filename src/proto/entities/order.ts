...
export const encodeOrderStatus: { [key: string]: number } = {
  CREATED: 0,
  SUCCESS: 1,
};

export const decodeOrderStatus: { [key: number]: OrderStatus } = {
  0: OrderStatus.CREATED,
  1: OrderStatus.SUCCESS,
};
...
function _encodeOrder(message: Order, bb: ByteBuffer): void {
  ...
  if ($status !== undefined) {
    writeVarint32(bb, 16);
    writeVarint32(bb, encodeOrderStatus[$status]);
  }
  ...
  // optional string commodityId = 6;
  let $commodityId = message.commodityId;
  if ($commodityId !== undefined) {
    writeVarint32(bb, 50);
    writeString(bb, $commodityId);
  }
}
...
function _decodeOrder(bb: ByteBuffer): Order {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional OrderStatus status = 2;
      case 2: {
        message.status = decodeOrderStatus[readVarint32(bb)];
        break;
      }

      // optional int64 createdAt = 3;
      case 3: {
        message.createdAt = readVarint64(bb, /* unsigned */ false);
        break;
      }

      // optional int64 updatedAt = 4;
      case 4: {
        message.updatedAt = readVarint64(bb, /* unsigned */ false);
        break;
      }
      ...
      // optional string commodityId = 6;
      case 6: {
        message.commodityId = readString(bb, readVarint32(bb));
        break;
      }
